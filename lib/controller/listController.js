...
meteoric.controller.ionicListDelegate = new ionicListDelegate();

meteoric.controller.ionicList =
    function($scope) {
      let $ionicListDelegate = meteoric.controller.ionicListDelegate;
      /**
       * @ngdoc method
      ...
      $ionicListDelegate.addAggregate(this);
      $($scope).on('$destroy', () => $ionicListDelegate.removeAggregate(this));
