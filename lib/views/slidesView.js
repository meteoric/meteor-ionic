...
(function () {
    ...
    Swiper
    ===========================*/
    var Swiper = function (container, params, _scope) {
        ...
        s.createLoop = function () {
            ...
            for (i = 0; i < appendSlides.length; i++) {
              newNode = $(appendSlides[i]).clone().addClass(s.params.slideDuplicateClass);
              newNode.removeAttr('ng-transclude');
              newNode.removeAttr('ng-repeat');
              scope = $(appendSlides[i]).scope();
              newNode = $compile(newNode)(scope);
              $(s.wrapper).append(newNode);
                //s.wrapper.append($(appendSlides[i].cloneNode(true)).addClass(s.params.slideDuplicateClass));
            }
            for (i = prependSlides.length - 1; i >= 0; i--) {
                //s.wrapper.prepend($(prependSlides[i].cloneNode(true)).addClass(s.params.slideDuplicateClass));

              newNode = $(prependSlides[i]).clone().addClass(s.params.slideDuplicateClass);
              newNode.removeAttr('ng-transclude');
              newNode.removeAttr('ng-repeat');

              scope = $(prependSlides[i]).scope();
              newNode = $compile(newNode)(scope);
              $(s.wrapper).prepend(newNode);
            }
        };
